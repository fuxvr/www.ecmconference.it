...
if (isset($_GET['idev'])){
$query_rs_lista = "SELECT *, DATE_FORMAT(data,'%d-%m-%Y') as Data FROM partecipanti WHERE evento = " .$_GET['idev'];
...
$totalRows_rs_eventi = mysql_num_rows($rs_eventi);
		...
		// QUERY ALL EVENTI
$query_rs_event = "SELECT * FROM associazioni WHERE account = '" .$_SESSION['myusername']."'" ;

$rs_event = mysql_query($query_rs_event, $conn) or die(mysql_error());
